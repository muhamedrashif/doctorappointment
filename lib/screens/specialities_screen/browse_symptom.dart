...
class BrowseSymptomScreen extends StatefulWidget {
  const BrowseSymptomScreen({super.key});

  @override
  State<BrowseSymptomScreen> createState() => _BrowseSymptomScreenState();
}

class _BrowseSymptomScreenState extends State<BrowseSymptomScreen> {
  TextEditingController searchController = TextEditingController();
  late CommonViewModel vm;
  List<GetsymptomsViewModel> _searchItems = [];
  @override
  void initState() {
    super.initState();
    vm = Provider.of<CommonViewModel>(context, listen: false);
    vm.getsymptoms().whenComplete(() => _searchItems = vm.getsymptom);
  }
  ...
  void _runFilter(String enteredKeyword) {
    List<GetsymptomsViewModel> results = [];
    if (enteredKeyword.isEmpty) {
      results = vm.getsymptom;
    } else {
      results = vm.getsymptom
          .where((item) => item.datas.symptomsname
              .toLowerCase()
    ...
    return SafeArea(
      child: Scaffold(
        appBar: CustomAppBar(
            ...
            centerTitle: true,
            title: AppbarTitle(text: "Browse by Symptom")),
        body: Container(
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return ViewallWidget(
                      ...
                      name: _searchItems[index].symptomsname,
                    );
                  })
          : ListView.builder(
              shrinkWrap: true,
              ...
              itemBuilder: (context, index) {
                return ViewallWidget(
                  ...
                  image: WebService().imageurl + value.getsymptom[index].image,
